...
from gui.experiment_runner import VisualizationRunner
...
class VisualizationTab:
    ...
    def _create_sidebar(self):
        ...
        algo_label.grid(row=3, column=0, padx=20, pady=(10, 5), sticky="w")
        
        self.algo_menu = customtkinter.CTkOptionMenu(
            self.sidebar_frame,
            values=["PSO", "ACO", "ABC", "FA", "CS"],
            width=260,
            height=35,
            font=customtkinter.CTkFont(size=12)
        )
        self.algo_menu.grid(row=4, column=0, padx=20, pady=(0, 15))
        ...
        problem_label.grid(row=5, column=0, padx=20, pady=(10, 5), sticky="w")
        ...
        self.problem_menu.grid(row=6, column=0, padx=20, pady=(0, 15))
        ...
        params_label.grid(row=7, column=0, padx=20, pady=(10, 10), sticky="w")
        
        self.params_frame = customtkinter.CTkFrame(self.sidebar_frame, fg_color="transparent")
        self.params_frame.grid(row=8, column=0, padx=20, pady=(0, 15), sticky="ew")
        ...
        self.iter_entry = customtkinter.CTkEntry(self.params_frame, placeholder_text="100", width=260, height=30)
        self.iter_entry.grid(row=3, column=0, padx=0, pady=(0, 8), sticky="ew")
        ...
        self.runs_entry = customtkinter.CTkEntry(self.params_frame, placeholder_text="10", width=260, height=30)
        ...
        sep2.grid(row=9, column=0, padx=20, pady=15, sticky="ew")
        ...
        self.save_button.grid(row=11, column=0, padx=20, pady=(0, 10))
        ...
        self.status_label.grid(row=13, column=0, padx=20, pady=(10, 20), sticky="s")
    ...
    def _create_results_area(self):
        ...
        self.performance_btn.grid(row=0, column=1, padx=5, sticky="ew")
        ...
        self.sensitivity_btn.grid(row=0, column=2, padx=5, sticky="ew")
        ...
        self.landscape_btn.grid(row=0, column=3, padx=(5, 0), sticky="ew")
